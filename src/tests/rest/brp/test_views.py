...
class TestIngeschrevenpersonenBsnView:
    ...
    def test_in_onderzoek_j(self, stuf_310_response, app_base_path, client, jwt_header, monkeypatch):
    ...
    def test_in_onderzoek_n(self, stuf_310_response, app_base_path, client, jwt_header, monkeypatch):
    ...
    def test_in_onderzoek_missing(self, stuf_310_response, app_base_path, client, jwt_header, monkeypatch):
