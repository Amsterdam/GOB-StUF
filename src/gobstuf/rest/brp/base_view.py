...
class StufRestViewAsList(StufRestView, ABC):
    """
    StufRestViewAsList is a StufRestView which returns a list response.

    Use case:
      - Raise 404 on not found bsn, don't return empty list response
    """
